    ...
    return ( 
        <main className="relative top-[100px] w-full pt-5 md:pt-10 pb-20 px-[5%] grid grid-cols-1 md:grid-cols-2 items-center md:items-start gap-10 md:gap-52">
            <section className="grid gap-2">
                ...
                <div className="grid items-center justify-center place-items-center gap-4 text[14px] md:text-[16px] text-dark border-dashed border-[3px] rounded-xl p-8">
                    <Image src="/img/upload-img.png" width={100} height={100} alt="upload-img" />
                
                    <p className="text-[16px] text-dark text-center">Drag and drop file to create QR code</p>
                
                    <button className="w-full text[14px] md:text-[16px] px-3 md:px-5 py-2.5 md:py-3 bg-blue text-white font-semibold rounded-md hover:shadow-lg transition-all delay-150">Browse File</button>
                </div>
