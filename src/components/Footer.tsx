    ...
    return ( 
        <main className="bg-darkblue px-[5%] py-10 relative top-[50px] grid gap-8">
            <section className="grid grid-cols-1 md:grid-cols-3 items-center justify-center gap-8">
                ...
                <div className="text-[14px] md:text-[16px] text-offwhite font-semibold flex items-center justify-center md:justify-between gap-6 md:gap-0">
                ...
                <div className="flex items-center md:items-end justify-center md:justify-end gap-4">
            ...
            <p className="text-[14px] md:text-[16px] text-offwhite text-center">Copyright@2024 QR-Go. All Rights Reserved.</p>
