...
const UserProfile = () => {
    return (
        <main className="w-full h-full relative top-[100px] mb-10">
            <section className="bg-darkblue w-full h-[150px] mt-5 mb-20 px-[5%] py-5">
                    ...
                    <div className="grid gap-2">
                        ...
                        <div className="absolute bottom-[-150px] left-[10px] flex flex-col items-center justify-center gap-4 z-10">
                            <div className="p-2 rounded-full bg-white shadow-lg w-[150px]">
                                <Image src="/img/user.png" width={100} height={100} alt="user" className="w-full"/>
                            </div>

                            <div className="flex items-center gap-4">
                                <button className="text-[16px] px-4 py-1 bg-blue text-white font-semibold rounded-md hover:shadow-lg transition-all delay-150 cursor-pointer">View</button>
                                <button className="text-[16px] px-4 py-1 bg-white text-blue border border-blue font-semibold rounded-md hover:shadow-lg transition-all delay-150 cursor-pointer">Edit</button>
                            </div>
                        </div>
                    </div>

                    <div>
                        <button className="text-[16px] px-5 py-3 bg-blue text-white font-semibold rounded-md hover:shadow-lg transition-all delay-150">Edit Profile</button>
                    </div>
                </div>
                ...
                <div className="relative px-[5%] py-10">
                    <div className="flex items-end justify-end">
                        <div>
                            ...
                            <div className="text-[16px] text-dark font-semibold flex items-center gap-8">
            ...
            <section className="relative w-full h-full px-[5%] py-20 mt-[50px]">
                <form action="" className="grid grid-cols-2 gap-60 text-[16px] text-dark">
                    <div className="grid gap-2">
