    ...
    return ( 
        <main className="w-full grid gap-4 px-[10%]">
            <div className="grid gap-2">
                <h1 className="text-[40px] text-dark text-center font-semibold">Generate a <span className="text-blue">QR code</span></h1>
                <p className="text-[16px] text-dark text-center">Get started and generate a Qr code on the go</p>
            </div>
            ...
            <form action="" className="grid gap-4 text-[16px] text-dark">
                ...
                <button className="bg-blue px-10 py-2 rounded-md text-[16px] text-center text-white font-semibold">Create account</button>

                <p className="text-[14px] text-dark text-center">Already have an account? <span className="text-darkblue cursor-pointer" onClick={onSwitch}>Login</span></p> 
            </form>
