        ...
        <main className="w-full px-[5%] relative top-[80px] py-10">
            <section className="w-full grid grid-cols-2 items-center justify-center place-items-center">
                <section className="grid gap-4">
                    <h1 className="max-w-[80%] text-[42px] text-dark font-semibold"><span className="text-blue">QR code</span> generator that makes all the <span className="text-blue"> difference.</span></h1>
